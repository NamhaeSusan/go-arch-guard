...
src, err := scaffold.ArchitectureTest(
    scaffold.PresetDDD, // or PresetCleanArch / PresetLayered / PresetHexagonal / PresetModularMonolith / PresetConsumerWorker
...
> **참고:** Consumer/Worker 프리셋은 플랫 레이아웃이므로 도메인 격리 규칙이 적용되지 않습니다.
